...
btnEnviarFoto.addEventListener("click", () => {
    const cadastroRegistrado = localStorage.getItem("cadastro");
    const cadastroRevertido = JSON.parse(cadastroRegistrado);
    
    cadastroRevertido.imagem = imagemUrl;

    localStorage.setItem("cadastro", JSON.stringify(cadastroRevertido));
